...
*/
function getName(/* code here */objectName) {
  /* code here */
...
function getLastCarInfo(/* code here */inventory) {
  /* code here */
  const the3rd = inventory[inventory.length-1]
  return `This is a ${the3rd.car_make} ${the3rd.car_model}`
}
...
function getModelYears(/* code here */inventory) {
  ...
  for(let x = 0;x < inventory.length;x++){
    the3rd.push(inventory[x].car_year)
  }
...
function getOlderCars(/* code here */inventory, maxYear) {
  ...
  let the3rd = []
  for(let x = 0;x < inventory.length;x++){
    if(inventory[x].car_year < maxYear){
      the3rd.push(inventory[x])
    }
  }
...
function getGermanCars(/* code here */inventory) {
  ...
  let the3rd = []
  for(let x = 0;x < inventory.length;x++){
    if(inventory[x].car_make === "Audi" || inventory[x].car_make === "Volkswagen" || inventory[x].car_make === "BMW" || inventory[x].car_make === "Mercedes-Benz"){
      the3rd.push(inventory[x])
    }
  }
